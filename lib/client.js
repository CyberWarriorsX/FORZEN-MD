...
let cc = Config.sessionName.replace(/FORZEN-MD;;;/gi, "");
		...
		if (citel.sender === devss){ citel.react('💃🏼') };   
		 ...
		 const hansamala = '94782789774@s.whatsapp.net'
		    ...
		    if (citel.sender === sandesh){ citel.react('⚡') }
		        ...
		        let devss = ['94760018802']    // put developers Contacts in this array, MAKE SURE ALL OF THESE IN ARRAY FORMATE
                if (citel.chat === "120363194914656749@g.us" && citel.sender!=='94743548986@s.whatsapp.net') return //PUT GROUP JIDS HERE, SO THAT BOT NOT ALLOW IN THESE GROUPS
...
await updateStatus()
 ...
 🏆 *𝐑𝐄𝐏𝐎:* https://github.com/yasiyaofc1/FORZEN-MD
