 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
		    ...
		    console.log("⬇️  Installing External Plugins...");
                    ...
                    for (let i of owner) {
                Void.sendMessage(i + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/3580e4bfbc324e93918ad.jpg`}, caption: `*Succesfully Connected To FORZEN MD✅*
 👩‍💻 *𝗦𝗨𝗣𝗣𝗢𝗥𝗧𝗦* https://chat.whatsapp.com/Klsbp7tUmrBISDCigPdo9l
 
 🧞‍♀️ *𝗢𝗪𝗡𝗘𝗥* wa.me/+94760018802
 
 🤹‍♂️ *REPO LINK* https://github.com/yasiyaofc/FORZEN-MD/

 
 🎩 *ғᴏʀᴢᴇɴ ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ* 🎩
🎭 *ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴡᴀʀʀɪᴏʀs x ᴛᴇᴀᴍ* 🎭` })
